...
<script>
    ...
    import selectButton1 from '../../../activityManage/applyManage/selectButton';
    ...
    export default {
        ...
        data: function () {
            return {
                pvt_subModuleMap: {
                    vessel: ['statusList', 'title', 'statusTitle', 'confirmBtn', 'resetBtn', 'ticketText', 'ticketItem'],
                    subModule: ['selectBtnRef', 'titleRef', 'statusTitleRef', 'confirmBtnRef', 'resetBtnRef', 'ticketTitleRef', 'ticketBtnRef'],
                },
                pvt_isShow: {
                    statusList: null,
                    title: null,
                ...
                selectBtnChecked: [],
                selectBtnCheckedClone: [true, false, false, false, false],
                ticketBtnChecked: [],
        ...
        computed: {
            ...
            pvt_statusList: function () {
                let loopModule = {
                    selectBtnRef: {
                        para: {
                            btnText: ['全部','助手', '主持人', '主讲人', '在线客服'],
                        },
                        attr: {
                            size: ['medium', 'medium', 'medium', 'medium', 'medium'],
        ...
        methods: {
            startModule: function (curClerk, curJoin, successCallBack, errorCallBack) {
                let that = this;
                let fnname = 'selectDialogJoin_start';
                let dbFlag;
                let dbData;
                let tableName;
                let para = {
                ...
                let refArr = ['titleRef', 'statusTitleRef', 'confirmBtnRef', 'resetBtnRef', 'ticketTitleRef'];
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        case 0:
                            this.curClerk = curClerk;
                            this.curJoin = curJoin;

                            let statusList = ['全部','助手', '主持人', '主讲人', '在线客服'];
                            let ticketList = ['全部','已参与', '待参与'];

                            statusList.forEach(function (item, index) {
                                item === curClerk ? that.selectBtnChecked.push(true) : that.selectBtnChecked.push(false);
                            });
                            ticketList.forEach(function (item, index) {
                                item === curJoin ? that.ticketBtnChecked.push(true) : that.ticketBtnChecked.push(false);
                            });

                            that.forceUpdateData(function () {
                                para.nStep = 'start_sub';
                                if (++dbFlag === 2) {
                                    that.startModule(curClerk, curJoin, successCallBack, errorCallBack)
                                }
                            });
                            break;
                        case 'start_sub':
                        ...
                        case 'ticketItemStart':
                            ...
                            break;
                        case 'showSubModule':
                            refArr.push('selectBtnRef', 'ticketBtnRef');
            ...
            dialogConfirm: function () {
                this.ep.confirmEvent(this.curClerk, this.curJoin);
            },
            ...
            statusBtnRefresh: function (index) {
                ...
                this.selectBtnCheckedClone.forEach(function (item, index1, oldArr) {
                    index1 === index ? that.selectBtnChecked.push(true) : that.selectBtnChecked.push(false);
                });

                let statusList = ['全部','助手', '主持人', '主讲人', '在线客服'];
                this.curClerk = statusList[index];
            ...
            ticketBtnRefresh: function (index) {
                ...
                this.ticketBtnCheckedClone.forEach(function (item, index1, oldArr) {
                    index1 === index ? that.ticketBtnChecked.push(true) : that.ticketBtnChecked.push(false);
                });

                let ticketList = ['全部','已参与', '待参与'];
                this.curJoin = ticketList[index];
