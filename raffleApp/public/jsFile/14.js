...
function $$$event1() {//prizeShowOut
  var $this = this;

  /*事务变量初始化*/
  $this.$variable = {};
  $this.$variable.nickName = null;
  $this.$variable.headShotUrl = null;
...
$$$event1.prototype.$event1 = function(successCallBack, errorCallBack) {
  ...
  let $this = this;
  $this.$actionRun('$event1', 'a1', [$this.$eventObject.$variable.nickName,$this.$eventObject.$variable.headShotUrl,$this.$eventObject.$variable.openId], function(result) {
