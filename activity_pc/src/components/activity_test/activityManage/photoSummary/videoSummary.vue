<template>
    <div class="video-summary-wrap">
        <div class="video-empty" v-show="isEmpty">
            <div class="empty-img">
                <lm-image
                        ref="emptyImgRef"
                        refId="emptyImgRef"
        ...
        <div class="video-exist" v-show="!isEmpty">
            <lm-album-upload
                    ref="photoRef"
                    refId="photoRef"
            ...
            pvt_emptyBtn: function () {
                return {
                    emptyBtnRef: {
                        paraVarPair: {},
                        para: {
                            name: ['选择添加视频', 'el-icon-video-camera'],
                        },
                        attr: {
                            size: 'large',
                            type: 'primary'
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        ...
                        case 'getPhoto':
                            ...
                            expression = this.mac.fd.myPhoto.type + '=' + this.mac.enum.myPhoto.type.video;
                            dbData = {};
                            dbData[that.mac.fd.id] = [];
                            that.sys.api.recordQuery(tableName, [that.curAlbumId], expression, dbData, function (result) {
                                that.curPhotoIdArr = JSON.parse(JSON.stringify(dbData[that.mac.fd.id]));
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        ...
                        case 'newPhoto':
                            ...
                            dbData[that.mac.fd.myPhoto.type] = [that.mac.enum.myPhoto.type.video];
