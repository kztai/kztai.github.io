...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                pvt_subModuleMap: {
                    vessel: ["v1","v2","v3","v4","v5","v6","v7","v8","v9","v9","v10","v11","v12","v13","v14","v15","v16","v17","v17","v18","v19","v20","v21","v22","v23","v24"],
                    subModule: ["smImg","smText1","smText2","smText3","smText4","smText5","smText6","smText7","smButton1","smText14","smText8","smText9","smText10","smTicketType","smText11","smNumber","smText12","smButton2","smButton5","smButton3","smButton4","smPopover","smText13","smButton6","smButton7","smText15"]
                },
                pvt_isShow: {
                    "v1": null,
                    "v2": null,
            ...
            pvt_v17: function () {
                return {
                    smButton2: {
                        ...
                        attr: {
                            type: 'primary',height:'48px',width:'220px',disabled: true
                        }
                    },
                    smButton5: {
                        paraVarPair: {},
            ...
            pvt_v18: function () {
                return {
                    smButton3: {
                        paraVarPair: {},
                        para: {
                            name: ['收藏', 'el-icon-star-off']
                        },
                        attr: {
                            height:'48px',width:'98px',disabled: true
                        }
                    }
                }
            },
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                            ...
                            $this.sys.api.recordQuery(objectName,parentRecord,condition, dbData,
                                function () {
                                    ...
                                    if(dbData[$this.mac.fd.groupActivityTicketType.refundEndTime][0].toString().indexOf('-')!==-1){
                                        if(dbData[$this.mac.fd.groupActivityTicketType.refundEndTime][0] === 0||dbData[$this.mac.fd.groupActivityTicketType.refundEndTime][0] ===  para.sortObj['endTime'][0]){
                                            para.differTime = 0;
                                        }else{
                                    ...
                                    let tempStrArr = para.refundExplain['explain'].split("\n");
                                    var tempHtml = '';
                                    for(var i=0;i<tempStrArr.length;i++){
                                        tempHtml += '<div>'+tempStrArr[i]+'</div>'
                                    }
                                    if(para.refundExplain['type'] === $this.mac.enum.groupActivity.refundExplain.type.support){
                                        if(para.differTime === 0){
                                            para.html = '<div style="color:#12B0FF;height:38px;line-height:38px;padding:0 20px;border-bottom:1px solid #E5E5E5;">退款说明</div><div style="padding:0 20px;margin-top: 10px;">活动结束前可退款</div><div style="padding:10px 20px 10px 20px;line-height: 20px;">' + tempHtml + '</div>'
                                        }else {
                                            para.html = '<div style="color:#12B0FF;height:38px;line-height:38px;padding:0 20px;border-bottom:1px solid #E5E5E5;">退款说明</div><div style="padding:0 20px;margin-top: 10px;">活动开始前' + para.differTime + '天可退款</div><div style="padding:10px 20px 10px 20px;line-height: 20px;">' + tempHtml + '</div>'
                                        }
                                    }else{
                                        para.html = '<div style="color:#12B0FF;height:38px;line-height:38px;padding:0 20px;border-bottom:1px solid #E5E5E5;">退款说明</div><div style="padding:0 20px;margin-top: 10px;">本活动不支持退款</div><div style="padding:10px 20px 10px 20px;line-height: 20px;">'+tempHtml+'</div>'
                                    }
                                    ...
                                    if(dbData[$this.mac.fd.groupActivityTicketType.refundEndTime][0].indexOf('-')!==-1){
                                        para.differTime = new Date((new Date(para.activityEndTime) - new Date(dbData[$this.mac.fd.groupActivityTicketType.refundEndTime][0]))).getDate();
                                    }else{
                                        para.differTime = dbData[$this.mac.fd.groupActivityTicketType.refundEndTime][0];
                                    }
                                    ...
                                    if(para.sortObj['explain'][index]!==null){
                                        $this.tipText = '场次:'+para.startTime[index]+'～'+para.endTime[index]+'（说明：'+para.sortObj['explain'][index]+'）';
                                    }else{
                                    ...
                                    if((para.number-para.enrollNumber[para.sortObj['orderNumber'][index]])<$this.sellingMax){
                                        $this.sellingMax = (para.number-para.enrollNumber[para.sortObj['orderNumber'][index]]);
                                    }
                        ...
                        case 'showModules':
                            let refId
                            if(new Date(para.activityEndTime)<new Date()){
                                refId = ["smImg","smText1","smText2","smText3","smText4","smText5","smText6","smText7","smText8","smText9","smButton5","smButton3","smButton4","smPopover","smButton6","smButton7"];
                            }else{
                                if($this.tipText===''||$this.tipText===null){
                                    refId = ["smImg","smText1","smText2","smText3","smText4","smText5","smText6","smText7","smText8","smText9","smText10","smTicketType","smText11","smNumber","smText12","smButton2","smButton3","smButton4","smPopover","smText15"];
                                }else{
                                    refId = ["smImg","smText1","smText2","smText3","smText4","smText5","smText6","smText7","smText8","smText9","smText10","smTicketType","smText11","smNumber","smText12","smButton2","smButton3","smButton4","smPopover","smText13","smText15"];
                                }
                            }
                            if(para.place===null){
                                refId.push(ref.sm22)
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                            ...
                            $this.sys.api.recordRead(objectName, dbData,
                                function () {
                                    ...
                                    if(dbData[$this.mac.fd.groupActivityTicketType.explain][0]!==null){
                                        $this.tipText = '场次:'+para.startTime+'～'+para.endTime+'（说明：'+dbData[$this.mac.fd.groupActivityTicketType.explain][0]+'）';
                                    }else{
                                    ...
                                    $this.sellingMin = para.minNumber;
                                    $this.sellingNumber = para.minNumber;
                                    if((para.number-para.enrollNumber[para.orderNumber])<$this.sellingMax){
                                        $this.sellingMax = para.number-para.enrollNumber[para.orderNumber]
                                    }
                                    $this.forceUpdateData(function(){
                                        para.nStep = 'startModule15';
                                        dbFlag += 1;
                        ...
                        case 'startModule21':
                            ...
                            break;
                        case 'startModule24':
                            $this.sm['smText15'].startModule(function () {
