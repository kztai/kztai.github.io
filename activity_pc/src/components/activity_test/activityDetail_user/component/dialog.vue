        ...
        <div class="reportShare-dialog">
            ...
            <div class="row">
                ...
                <lm-qrcode
                        ref="smQrcode"
                        refId="smQrcode"
                        v-show="pvt_isShow.v6 === 'smQrcode'"
                        :paraVarPair="pvt_v6.smQrcode.paraVarPair"
                        :para="pvt_v6.smQrcode.para"
                        :attr="pvt_v6.smQrcode.attr">
                </lm-qrcode>
            </div>
...
<script>
    ...
    export default {
        ...
        data: function () {
            return {
                pvt_subModuleMap: {
                    ...
                    subModule: ["smText1","smButton1","smRadio","smButton2","smButton3","smQrcode"]
                },
                pvt_isShow: {
                    "v1": null,
                    "v2": null,
        ...
        methods: {
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        case 0:
                            ...
                            break;
                        case 'hideModule':
                            $this.showSubModule(["smText1","smButton1","smRadio","smButton2","smButton3","smQrcode"], false, function () {
                        ...
                        case 'showModules':
                            ...
                            let refId;
                            if($this.attr.type === 'share'){
                               refId = ["smText1","smButton1","smButton2","smButton3","smQrcode"];
                            }else{
            ...
            reportShareClose:function(flag){
                if(this.attr.type !== 'share'&&flag){
                    let temp;
                    for(var i=0;i<this.radioArr.length;i++){
                        if(this.radioArr[i].label===this.radioData){
                            temp = this.radioArr[i].text;
                            break;
                        }
                    }
                    console.log('举报内容为'+temp);
                }
