...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        case 0:
                            ...
                            break;
                        case 'hideModules':
                            $this.showSubModule(["smImg","smText1","smText2","smText3","smDiscussReply"], false, function () {
                        ...
                        case 'showModules':
                            let refId;
                            if(para.answerContent===null){
                                refId =  ["smImg","smText1","smText2","smText3"];
                            }else{
            ...
            smReplyInput_discussAnswerEvent:function (activityDiscussID,successCallBack, errorCallBack) {
                this.discussPublish(successCallBack, errorCallBack)
            }
        }
    }
