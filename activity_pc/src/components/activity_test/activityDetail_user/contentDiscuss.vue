                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        ...
                        case 'queryGroupActivityHandle':
                            ...
                            parentRecord = null;
                            condition = $this.mac.fd.groupActivityHandle.groupActivityID +'='+ $this.para.activityID +'&&'+$this.mac.fd.groupActivityHandle.handler +'='+$this.getUserID()['id'];
                            dbData = {};
                ...
                if($this.inputText===''||$this.inputText===null){
                    ...
                    $this.sys.api.recordNew(objectName, parentRecord, dbData,
                        function (result) {
                            ...
                            $this.sys.api.dataOutput($this.mac.tb.groupActivityDiscuss, [groupActivityDiscussID], '', function (result) {},function (error) {console.error(error)})
