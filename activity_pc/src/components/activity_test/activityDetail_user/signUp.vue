                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        ...
                        case 'inputGroupActivityHandle':
                            ...
                            var expression = $this.mac.fd.groupActivityHandle.groupActivityID +'='+ $this.para.activityID +'&&'+$this.mac.fd.groupActivityHandle.handler +'='+$this.getUserID()['id'];
                            var start = null;
                            var total = 1;
                            var sort = ['id,asc'];
                            var destGeneSite = '';
                            $this.sys.api.conditiondataInput($this.mac.tb.groupActivityHandle, geneInputData, expression, start, total, sort, destGeneSite,function(result){
                                if(result===null){
                                    ...
                                    para.groupActivityHandleID = result[0];
            ...
            moduleChange:function(number,successCallBack, errorCallBack){
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        ...
                        case 'isLogin':
                            if($this.para.isLogin){
                                para.nStep = 'getTicketNumberEvent';
                            }else{
                                $this.$confirm('请先登录再进行操作', '提示', {
                                    confirmButtonText: '前往登录',
                                    cancelButtonText: '取消',
            ...
            activityHandle:function(successCallBack, errorCallBack){
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        ...
                        case 'startModule1':
                            $this.sm['smButton3'].startModule(function () {
                                para.nStep = 'activityHandleQuery';
                                dbFlag += 1;
                                if (dbFlag === 2) {
                                    $this.activityHandle(successCallBack, errorCallBack)
                                }
                        ...
                        case 'activityHandleQuery':
                            objectName = $this.mac.tb.groupActivityHandle;
                            parentRecord = null;
                            condition = $this.mac.fd.groupActivityHandle.handler +'='+ $this.getUserID()['id'] + '&&' + $this.mac.fd.groupActivityHandle.groupActivityID +'='+ $this.para.activityID;
                            dbData = {};
                            dbData[$this.mac.fd.id] = [];
                            $this.sys.api.recordQuery(objectName,parentRecord,condition, dbData,
                                function () {
                        ...
                        case 'activityHandleNew':
                            ...
                            dbData = {};
                            parentRecord = null;
                            dbData[$this.mac.fd.groupActivityHandle.groupActivityID] = [$this.para.activityID];
                        ...
                        case 'activityHandleModify':
                            ...
                            dbData = {};
                            dbData[$this.mac.fd.id] = [para.groupActivityHandleID];
                            if(para.commandType === $this.mac.activityHandle.type.newFavorite){
                                dbData[$this.mac.fd.groupActivityHandle.favorite] = [$this.mac.enum.groupActivityHandle.favorite.yes];
                                dbData[$this.mac.fd.groupActivityHandle.favoriteTime] = [$this.getCurrentTime()];
                            }else{
                        ...
                        case 'getSourceRecord':
                            var tableName = $this.mac.tb.groupActivityHandle;
                            var arrRecord = [$this.para.activityID];
                            $this.sys.api.getSourceRecord(tableName,arrRecord,
                                function (result) {
                                    para.SourceRecord = result[0];
