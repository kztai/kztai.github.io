                ...
                <div class="row row2_1_row1">
                    <div class="col orderAndCollectionPage_row2_1_row1_col1">
                        <lm-list ref="smList"
                                 ...
                                 :attr="pvt_wList.smList.attr"></lm-list>
                    </div>
                    <div class="col orderAndCollectionPage_row2_1_row1_col2">
                        <my-order ref="smOrder"
                                  ...
                                  :attr="pvt_wMain.smOrder.attr"></my-order>
                        <my-collection ref="smCollection"
                                       ...
                                       :attr="pvt_wMain.smCollection.attr"></my-collection>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            startModule: function (api, tabsIndex, successCallBack, errorCallBack) {
                let $this = this;
                let para;
                let dbFlag;
                    ...
                    switch (para.nStep) {
                        ...
                        case 'downloadGroupActivity':
                            ...
                            data[portName] = [
                                ...
                                mac.mac.fd.groupActivity.endTime,
                                mac.mac.fd.groupActivity.mode,
                                mac.mac.fd.groupActivity.place,
                                mac.mac.fd.groupActivity.author,
                                mac.mac.fd.groupActivity.groupName,
                                mac.mac.fd.groupActivity.enrollNumber
                            ];
                            ...
                            $this.sys.api.conditiondataInput(portName, data, expression, start, total, sort, destGeneSite, function (result) {
                                ...
                                if (++dbFlag === 2) {
                                    $this.startModule(api, tabsIndex, successCallBack, errorCallBack);
                                }
                            }, para.errorCallBack);
                            break;
                        case 'showModules':
                            ...
                            let refId = [
                                'smHeader',
                                'smList',
                                $this.tabsIndex === 0 ? 'smOrder' : 'smCollection',
                                'smFooter'
                            ];
            ...
            smOrder_detailPageEvent(activityId, orderId) {
                this.ep.detailPageIn(activityId, orderId);
            },
            smOrder_orderCancelEvent(billId) {
                this.ep.orderCancelIn(billId);
            },
            smOrder_orderRefundEvent(billId, commandType) {
                this.ep.orderRefundIn(billId, commandType);
            },
            smOrder_completeActivityEvent(billId) {
                this.ep.completeActivityIn(billId);
            },
            smCollection_detailPageEvent(activityId) {
                this.ep.detailPageIn(activityId);
            }
        }
    }
</script>
