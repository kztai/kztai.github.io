...
<script>
  ...
  //引入子组件
  import ListRow from './activityListRow.vue';

  export default {
    name:'ActivityListRowsAndPaging',
        ...
        let loopModule = {
          listRow:{
            para:{
              ...
              mode:this.modeArr,
              startDate:this.startDateArr,
              endDate:this.endDateArr,
              price:this.priceArr,
              applicantsNum:this.applicantsNumArr,
              ticketsNum:this.ticketsNumArr,
              lastTicketEndSaleTime:this.lastTicketEndSaleTimeArr
            },
            attr:{}
          },
        };
        ...
        while(1){
          ...
          switch(para.nStep){
            case 0:
              ...
              if($this.para.nameArr){
                $this.nameArr = $this.para.nameArr;
              }
              if($this.para.addressArr){
                $this.addressArr = $this.para.addressArr;
              }
              if($this.para.modeArr){
                $this.modeArr = $this.para.modeArr;
              }
              if($this.para.startDateArr){
                $this.startDateArr = $this.para.startDateArr;
              }
              if($this.para.endDateArr){
                $this.endDateArr = $this.para.endDateArr;
              }
              if($this.para.priceArr){
                $this.priceArr = $this.para.priceArr;
              }
              if($this.para.applicantsNumArr){
                $this.applicantsNumArr = $this.para.applicantsNumArr;
              }
              if($this.para.ticketsNumArr){
                $this.ticketsNumArr = $this.para.ticketsNumArr;
              }
              if($this.para.lastTicketEndSaleTimeArr){
                $this.lastTicketEndSaleTimeArr = $this.para.lastTicketEndSaleTimeArr;
              }
