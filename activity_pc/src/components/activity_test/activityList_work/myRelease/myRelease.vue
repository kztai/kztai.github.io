...
<script>
    ...
    export default {
        ...
        methods: {
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        ...
                        case 'start_1':
                            ...
                            break;
                        case 'showSubModule1':
                            that.showSubModule('tabsRef', true, function () {
                                para.nStep = 'start_2';
                                if (++dbFlag === 2) {
                                    that.startModule(successCallBack, errorCallBack)
                                }
                        ...
                        case 'end':
                            ...
                            setTimeout(function () {
                                that.sm[ref.tabsRef].checkedLabel(0);
                                that.curTabIndex = 0;
                            }, 20);
                            return
                    }
                    ...
                    switch (para.nStep) {
                        ...
                        case 'modifyData':
                            ...
                            that.sys.api.recordModify(tableName, dbData, function () {
                                ...
                                that.ep.activityDeleteEvent(curActivityId, terActivityId);
                                para.nStep = 'end';
                                if (++dbFlag === 2) {
                                    that.activityDel(curActivityId, terActivityId, successCallBack, errorCallBack)
                                }
            ...
            activityItemRef_checkEvent: function (curActivityId, terActivityId, type) {
                this.ep.managePageEvent(curActivityId, terActivityId, type);
            },
            activityItemRef_photoEvent: function (curActivityId, terActivityId, type) {
                this.ep.managePageEvent(curActivityId, terActivityId, type);
            },
