    ...
    export default {
        ...
        data: function () {
            return {
                ...
                indexDataArr: [],
                // indexDataArr: [[8, 9, 11, 6, 14, 5, 1,10,12], [7, 2, 8, 9, 29, 3, 13,0,0], [6, 9, 1, 4, 12, 13, 20,0,0], [5, 2, 9, 4, 12, 3, 26,0,0]],
                ...
                indexDataArrClone: [],
                // indexDataArrClone: [[8, 9, 1, 4, 23, 13, 10,0,0], [7, 2, 8, 9, 29, 3, 13,0,0], [6, 9, 1, 4, 12, 13, 20,0,0], [5, 2, 9, 4, 12, 3, 26,0,0]],
