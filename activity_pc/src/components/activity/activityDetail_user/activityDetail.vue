...
<script>
    ...
    export default {
        ...
        components: {
            activityHeader, activityFooter, activityDetailCom, rollingBlock, orderInput,applySuccess,orderConfirm,orderApproval
        },
        data: function () {
            return {
                pvt_subModuleMap: {
                ...
                pvt_eventPortInput: ['moduleChangeEvent', 'activityBrowseIn', 'activityHandleIn', 'getHandleStateIn', 'getAttentionStateIn', 'groupAttentionIn', 'discussQuestionIn', 'getTicketNumberIn', 'getSumIn', 'thirdPayIn', 'balancePayIn'],
