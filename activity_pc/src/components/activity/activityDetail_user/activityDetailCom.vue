...
<script>
    ...
    export default {
        ...
        inject: ['sys'],
        components: {
            signUp,contentDiscuss
        },
        data: function () {
            return {
                pvt_subModuleMap: {
                    vessel: ["v1", "v2","v3"],
                    subModule: ["smSignUp", "smTabs", "smContentDiscuss"]
                },
                pvt_isShow: {"v1": null, "v2": null, "v3": null},
                pvt_eventPortInput: ['moduleChangeEvent','activityBrowseEvent','activityHandleEvent','getHandleStateEvent','getAttentionStateEvent','groupAttentionEvent','discussQuestionEvent','getTicketNumberEvent','getSumEvent'],
