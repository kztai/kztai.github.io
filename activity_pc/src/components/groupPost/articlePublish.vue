<template>
    <div id="group-article-wrap" class="screen-change">
        <header>
    ...
    export default {
        ...
        data: function () {
            return {
                ...
                pvt_vesselRef: {
                    vesselId: ['foot', 'head', 'publishText', 'textEditor', 'sortText', 'checkbox', 'limitText', 'limitRadio', 'publishBtn', 'title', 'closeComment', 'privacy', 'closeText', 'draftBtn', 'titleText', 'editorText', 'moreText', 'tagManager'],
                    ref: ['footRef', 'headRef', 'publishTextRef', 'textEditorRef', 'sortTextRef', 'checkboxRef', 'limitTextRef', 'limitRadioRef', 'publishBtnRef', 'titleRef', 'closeCommentRef', 'privacyRef', 'closeTextRef', 'draftBtnRef', 'titleTextRef', 'editorTextRef', 'moreTextRef', 'tagManagerRef']
                },
                    ...
                    limitRadioRef: {
                        para: {
                            ...
                            radioArr: {
                                $table: '',
                                $field: [],
                                $value: [{label: 0, text: "公开"}, {label: 1, text: "仅成员可见"}]
                            },
                        },
                    },
                };
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        ...
                        case 'newBlog':
                            ...
                            dbData = {};
                            dbData[this.mac.fd.groupBlog.blogType] = [1];
                        ...
                        case 'getBlogData':
                            ...
                            that.sys.api.recordRead(tableName, dbData, function () {
                                that.articleValue = dbData[that.mac.fd.groupBlog.details][0];
                                that.titleValue = dbData[that.mac.fd.groupBlog.name][0];
                ...
                while (1) {
                    ...
                    switch (para.nStep) {
                        ...
                        case 'writeCompressFile':
                            tableName = that.mac.tb.groupBlog;
                            fieldName = that.mac.fd.groupBlog.thumbnail;
                        ...
                        case 'modifyBlog':
                            ...
                            data[this.mac.fd.groupBlog.name] = [this.titleValue];
                            data[this.mac.fd.groupBlog.abstract] = [abstract];
                            data[this.mac.fd.groupBlog.details] = [articleStr];
